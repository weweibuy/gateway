 ...
 */
package com.weweibuy.gateway.sentinel.common.command;
...
import com.weweibuy.gateway.sentinel.common.api.ApiPathPredicateItem;
...
public class UpdateGatewayApiDefinitionGroupCommandHandler implements CommandHandler<String> {
    ...
    private Set<ApiDefinition> parseJson(String data) {
        ...
        return JackJsonUtils.readValue(data, Set.class, ApiDefinition.class);
    }
