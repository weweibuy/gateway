...
public class CoreWebConfigurer {
    ...
    public WebExceptionHandler webExceptionHandler(ObjectProvider<List<ViewResolver>> viewResolversProvider, ServerCodecConfigurer serverCodecConfigurer) {
        ...
        return new WebExceptionHandlerImpl(viewResolversProvider, serverCodecConfigurer, composite);
    }
