...
public class OpLogConfigExample {
    ...
    public OpLogConfigExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public OpLogConfigExample orderBy(String ... orderByClauses) {
    ...
    public static Criteria newAndCreateCriteria() {
        OpLogConfigExample example = new OpLogConfigExample();
        return example.createCriteria();
    }

    public OpLogConfigExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public OpLogConfigExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private OpLogConfigExample example;

        protected Criteria(OpLogConfigExample example) {
            super();
            this.example = example;
        }

        public OpLogConfigExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.weweibuy.gateway.router.model.example.OpLogConfigExample example);
    }
}