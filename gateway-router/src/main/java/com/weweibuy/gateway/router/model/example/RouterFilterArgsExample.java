...
public class RouterFilterArgsExample {
    ...
    public RouterFilterArgsExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public RouterFilterArgsExample orderBy(String ... orderByClauses) {
    ...
    public static Criteria newAndCreateCriteria() {
        RouterFilterArgsExample example = new RouterFilterArgsExample();
        return example.createCriteria();
    }

    public RouterFilterArgsExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public RouterFilterArgsExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public static class Criteria extends GeneratedCriteria {
        private RouterFilterArgsExample example;

        protected Criteria(RouterFilterArgsExample example) {
            super();
            this.example = example;
        }

        public RouterFilterArgsExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(com.weweibuy.gateway.router.model.example.RouterFilterArgsExample example);
    }
}